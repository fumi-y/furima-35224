class OrderAddress
  ...
  attr_accessor :user_id, :item_id, :postal_code, :prefecture_id, :municipality, :street_number, :building_name, :telephone_number
  ...
  with_options presence: true do
    ...
    validates :telephone_number, numericality: {other_than: 0}
  end
